...
export class WasmEmulator {
    ...
    key_press(key, pressed) {
        wasm.wasmemulator_key_press(this.__wbg_ptr, key, pressed);
    }
    /**
     ...
     */
    get_display() {
        const ret = wasm.wasmemulator_get_display(this.__wbg_ptr);
     ...
     */
    screen_width() {
        const ret = wasm.wasmemulator_screen_width(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Get screen height
     ...
     */
    screen_height() {
        const ret = wasm.wasmemulator_screen_height(this.__wbg_ptr);
        return ret >>> 0;
    }
}
